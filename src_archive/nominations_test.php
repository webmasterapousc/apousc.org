...
?>
	...
	<!--
		...
		table.pretty tr.thead td{color:#fff;background-color:#c30;font-size:1.2em;font-weight:400;padding:1em;text-align:left}
...
?>
			...
			if (!$session->logged_in) {
				...
				$positionz[7] = "Fundraising Chair";
				$positionz[8] = "Interchapter Chair";
			?>
			<div class="contentBox">
				<p>Please review the <a href="docs/Officer Duties_EditedSpring2015.pdf">Officer Descriptions</a>, <a href="docs/Bylaws_EditedSpring2015.pdf">Bylaws</a>, and <a href="docs/Officer Election Policy (updated 7.6.15).pdf">Officer Election Policy</a> for procedures regarding elections and for a list of each position's responsibilities. If you wish to decline your nomination, please click "[Decline]" next to your name, or email <a href="mailto:webmaster.apousc@gmail.com">webmaster.apousc@gmail.com</a> so that the website administrator may decline on your behalf. <br/><br/><strong>If you are accepting your nominations, please be sure to submit the <a href="docs/Fall2016ElectedOfficerQuestionaire.docx">E-Board Application</a> by 11:59 PM Sunday, April 24th, 2016. </strong></br></br><strong>If you would like to apply for an appointed position, please submit your <a href="docs/Fall2016AppointedBoard.docx">A-Board Application </a> by 11:59 PM Tuesday, April 26th, 2016.</strong></p>
					...
					<tr class="thead">
						...
						while ($row = mysql_fetch_array($retval)) {
							...
							if ($declined) {
								...
								echo ("<a href=\"process.php?subsecondnomination=1&amp;user=".$row['name']."&amp;position=8\" title=\"Second Nomination\" onclick=\"return confirm('Are you sure you want to second this nomination?');\">Second Now</a>");
							} else {
								echo ("Seconded");
							}
							echo ("</td></tr>");
