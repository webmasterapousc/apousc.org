...
?>
	...
	// }					
					...
					// Fetch current user's information
						...
						else if(strcmp($_GET["span"],"soon") === 0)  {$dateSpan = "WHERE `end` >= DATE_SUB(NOW(), INTERVAL '8' HOUR) AND `end` <= DATE_ADD(CURDATE(), INTERVAL +14 DAY)";} // Note that this finds literally every upcoming event, even if it is in a future semester.
