...
if ($session->isOfficer()) {
	...
	echo " <p class=\"right\">";
	echo " <a href=\"process.php?subdeleteevent=1&amp;event=" . $req_event . "\" title=\"Delete Event\"onclick=\"if(confirm('This will delete the event.')); 
// 	confirm('It cannot be undone.'); confirm('Are you really sure you want to do this?'); confirm('No turning back.'); confirm('Think about this. Some people really love " . $req_event_info['name'] . ".'); confirm('You know, I think Myrtle Turtle mentioned something about enjoying " . $eventType[$req_event_info['type']] . " events. Maybe you should reconsider.'); confirm('This is your last chance. Are you sure you want to DELETE this event? This cannot be undone.'); return confirm('Just making sure.');
