            ...
            while ($row = mysql_fetch_array($result)) {
                ...
                if ($session->isOfficer() || $session->isFakeOfficer()) {
                    if (
                        ...
                        if ($req_event_info['type'] == 0) {echo ("<a href=\"process.php?subflake=1&amp;event=" . $req_event . "&amp;user=" . $row['username'] . "\" title=\"Flake\" onclick=\"return confirm('Are you sure you want to FLAKE " . $row['fname'] . " " . $row['lname'] . "?');\">&ndash;&frac12;</a>");} else {echo ("<a href=\"process.php?subflakeother=1&amp;event=" . $req_event . "&amp;user=" . $row['username'] . "\" title=\"Flake\" onclick=\"return confirm('Are you sure you want to FLAKE " . $row['fname'] . " " . $row['lname'] . "?');\">-1</a>");}
                        ;
