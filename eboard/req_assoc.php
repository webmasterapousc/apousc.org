...
// Set values for page
$page_title = "Requirements :: Associates";
...
?>
		...
		<table cellpadding="0" cellspacing="0" border="0" class="pretty">
			...
			<tbody>
<tr><td><em>Required</em></td><td><em>10</em></td><td><em>3</em></td><td><em>1</em></td><td><em>2</em></td></tr>
<?php
	$sortorders = array(
		"first"  => "fname",
		"last"   => "lname",
	...
	while ($row = mysql_fetch_array($result)) {
		...
		if ($row[totalSer] >= 10) {echo "<td class='comp'>";} else {echo "<td class='incomp'>";};
			echo round($row[totalSer],2)."</td>\n";
		if ($row[totalFel] >= 3) {echo "<td class='comp'>";} else {echo "<td class='incomp'>";};
			echo round($row[totalFel],2)."</td>\n";
		if ($row[totalFund] >= 1) {echo "<td class='comp'>";} else {echo "<td class='incomp'>";};
			echo round($row[totalFund],2)."</td>\n";
		if ($row[totalMem] >= 1) {echo "<td class='comp'>";} else {echo "<td class='incomp'>";};
